...
# Releasetools
TARGET_RELEASETOOL_OTA_FROM_TARGET_SCRIPT := ./$(LOCAL_PATH)/releasetools/rk30xx_ota_from_target_files
TARGET_RELEASETOOL_IMG_FROM_TARGET_SCRIPT := ./$(LOCAL_PATH)/releasetools/rk30xx_img_from_target_files
